...
$query = mysqli_query($con,
    "SELECT x.*, x1.nama_barang, x2.nama_merek, x3.nama_kategori
     ...
     WHERE x.tanggal='$now' ORDER BY x.idbarang_keluar DESC"
...
<title>Laporan Barang Keluar Hari Ini</title>
<style>
...
<table class="data">
    ...
    <tbody>
    <?php if (empty($rows)): ?>
        <tr><td colspan="8" align="center" style="padding:12px;">Tidak ada barang keluar hari ini</td></tr>
